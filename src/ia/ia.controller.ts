import { Body, Controller, HttpCode, Post, Res, ServiceUnavailableException } from '@nestjs/common';
...
export class IaController {
  ...
  @Post('responder')
  responder(@Body() dto: ResponderDto) {
    return this.iaService.responder(dto.mensagem);
  }
